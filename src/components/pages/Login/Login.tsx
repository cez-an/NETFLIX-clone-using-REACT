    ...
    <>
      ...
      >
        ...
        <div className=" bg-black/65 z-10 p-10">
          <h1 className="text-3xl py-10">Sign Up</h1>
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            />
            <button className="bg-red-600 rounded py-4 w-full"> Sign Up</button>
          ...
          <h1 className="text-md text-center mt-15 text-gray-400">Already have Account? <span className="text-white font-bold"> Sign In Now</span> </h1>
        </div>
      </section>
    </>
  );
